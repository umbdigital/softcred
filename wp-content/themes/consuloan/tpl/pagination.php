...
$next_link = get_next_posts_link( esc_html__( 'Next', 'consuloan' ) );
$prev_link = get_previous_posts_link( esc_html__( 'Previous', 'consuloan' ) );
$loadmore_text = apply_filters('themesflat/template/loadmore_text',esc_html__('Load More','consuloan'));
...
<?php elseif ( $themesflat_paging_style == 'loadmore' && ! empty( $next_link ) ): ?>
	...
	<nav class="navigation <?php themesflat_esc_attr($themesflat_paging_for);?> paging-navigation loadmore" role="navigation">
		<div class="pagination loop-pagination">
